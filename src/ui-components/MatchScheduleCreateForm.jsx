...
export default function MatchScheduleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setGame_time(initialValues.game_time);
    setErrors({});
  };
  const validations = {
    game_time: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MatchSchedule(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MatchScheduleCreateForm")}
      {...rest}
    >
      <TextField
        label="Game time"
