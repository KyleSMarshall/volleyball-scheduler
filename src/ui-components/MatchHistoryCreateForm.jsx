...
export default function MatchHistoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setResult_1(initialValues.result_1);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MatchHistory(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MatchHistoryCreateForm")}
      {...rest}
    >
      <TextField
        label="Result 1"
